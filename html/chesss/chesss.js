...
for (i = 1; i < 65; i++) {
    ...
    if ((x + y) % 2 == 0) {
        ...
        div.style.backgroundColor = "#40739e";
...
class Pawn extends Piece {
    ...
    getpossiblemoves = () => {
        ...
        if (this.color == "black") {
            ...
            const box1=document.querySelector(`div[data-cards="(${this.currentPos.x+1},${this.currentPos.y+1})"]`)
...
const pb3 = new Pawn("black", "black pawn", 3, 3, "../media/b_pawn.svg")
...
const bw2 = new bishop("white", "white bishop", 4, 4, "../media/w_bishop.svg")
